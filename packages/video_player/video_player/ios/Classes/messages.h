...
@class FLTCameraRotationMessage;
@class FLTMediaFormatMessage;
...
@interface FLTCameraRotationMessage : NSObject
@property(nonatomic, strong, nullable) NSNumber * textureId;
...
-(void)setCameraRotation:(FLTCameraRotationMessage*)input error:(FlutterError *_Nullable *_Nonnull)error;
-(void)setMediaFormat:(FLTMediaFormatMessage*)input error:(FlutterError *_Nullable *_Nonnull)error;
@end
