...
-(NSDictionary*)toMap;
@end
@interface FLTCameraRotationMessage ()
+(FLTCameraRotationMessage*)fromMap:(NSDictionary*)dict;
-(NSDictionary*)toMap;
@end
@interface FLTMediaFormatMessage ()
...
@implementation FLTCameraRotationMessage
+(FLTCameraRotationMessage*)fromMap:(NSDictionary*)dict {
  FLTCameraRotationMessage* result = [[FLTCameraRotationMessage alloc] init];
  result.textureId = dict[@"textureId"];
  if ((NSNull *)result.textureId == [NSNull null]) {
    result.textureId = nil;
  }
...
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.textureId ? self.textureId : [NSNull null]), @"textureId", (self.roll ? self.roll : [NSNull null]), @"roll", (self.pitch ? self.pitch : [NSNull null]), @"pitch", (self.yaw ? self.yaw : [NSNull null]), @"yaw", nil];
}
@end
...
void FLTVideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<FLTVideoPlayerApi> api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.VideoPlayerApi.setCameraRotation"
        binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FLTCameraRotationMessage *input = [FLTCameraRotationMessage fromMap:message];
        FlutterError *error;
        [api setCameraRotation:input error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.VideoPlayerApi.setMediaFormat"
        binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FLTMediaFormatMessage *input = [FLTMediaFormatMessage fromMap:message];
        FlutterError *error;
        [api setMediaFormat:input error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
