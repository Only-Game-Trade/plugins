...
public class OpenGLRenderer {
    ...
    /**
     * Log GL calls to the system log at "verbose" level with tag "OpenGLRenderer".
     *
     * @see #getDebugFlags
     * @see #setDebugFlags
     */
    ...
    /**
     * Control whether the EGL context is preserved when the OpenGLRenderer is paused and
     * resumed.
     * <p>
     * If set to true, then the EGL context may be preserved when the OpenGLRenderer is paused.
     * <p>
     ...
     * to share the GPU.
     * <p>
     * If set to false, the EGL context will be released when the OpenGLRenderer is paused,
     * and recreated when the OpenGLRenderer is resumed.
     * <p>
     * <p>
     ...
     * a OpenGLRenderer.
     * <p>The following OpenGLRenderer methods can only be called <em>before</em>
     ...
     * </ul>
     * <p>
     * The following OpenGLRenderer methods can only be called <em>after</em>
     * setRenderer is called:
     * <ul>
     ...
     * not normally called or subclassed by clients of OpenGLRenderer.
     */
     ...
     * OpenGLRenderer to continue rendering, such as in response to
     ...
     * called or subclassed by clients of OpenGLRenderer.
     */
     ...
     * {@link OpenGLRenderer#setEGLContextFactory(EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link OpenGLRenderer#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link OpenGLRenderer#setEGLConfigChooser(EGLConfigChooser)}
     */
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<OpenGLRenderer> OpenGLRendererWeakRef) {
            mOpenGLRendererWeakRef = OpenGLRendererWeakRef;
        }
        ...
        public void start() {
            ...
            OpenGLRenderer view = mOpenGLRendererWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        public boolean createSurface() {
            ...
            OpenGLRenderer view = mOpenGLRendererWeakRef.get();
            if (view != null) {
                mEglSurface = view.mEGLWindowSurfaceFactory.createWindowSurface(mEgl, mEglDisplay, mEglConfig, view.texture);
            } else {
                mEglSurface = null;
            }
        ...
        private WeakReference<OpenGLRenderer> mOpenGLRendererWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
        ...
        GLThread(WeakReference<OpenGLRenderer> OpenGLRendererWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
        ...
        private void guardedRun() throws InterruptedException {
            mEglHelper = new EglHelper(mOpenGLRendererWeakRef);
            mHaveEglContext = false;
            mHaveEglSurface = false;
            mWantRenderNotification = false;
         ...
         * called. This weak reference allows the OpenGLRenderer to be garbage collected while
    ...
    static class LogWriter extends Writer {
        ...
        private void flushBuilder() {
            if (mBuilder.length() > 0) {
                Log.v("OpenGLRenderer", mBuilder.toString());
    ...
    private final WeakReference<OpenGLRenderer> mThisWeakRef =
            new WeakReference<OpenGLRenderer>(this);
