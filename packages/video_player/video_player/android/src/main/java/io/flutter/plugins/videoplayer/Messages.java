...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class CameraRotationMessage {
    private Long textureId;
    public Long getTextureId() { return textureId; }
    public void setTextureId(Long setterArg) { this.textureId = setterArg; }
    ...
    static CameraRotationMessage fromMap(HashMap map) {
      CameraRotationMessage fromMapResult = new CameraRotationMessage();
      Object textureId = map.get("textureId");
      fromMapResult.textureId = (textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId);
  ...
  public interface VideoPlayerApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, VideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.setCameraRotation", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
              @SuppressWarnings("ConstantConditions")
              CameraRotationMessage input = CameraRotationMessage.fromMap((HashMap)message);
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.setMediaFormat", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
              @SuppressWarnings("ConstantConditions")
              MediaFormatMessage input = MediaFormatMessage.fromMap((HashMap)message);
