...
abstract class TestHostVideoPlayerApi {
  ...
  void setCameraRotation(CameraRotationMessage arg);
  void setMediaFormat(MediaFormatMessage arg);
  static void setup(TestHostVideoPlayerApi? api) {
    ...
    {
      const BasicMessageChannel<Object?> channel =
          BasicMessageChannel<Object?>('dev.flutter.pigeon.VideoPlayerApi.setCameraRotation', StandardMessageCodec());
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setCameraRotation was null. Expected CameraRotationMessage.');
          final CameraRotationMessage input = CameraRotationMessage.decode(message!);
          api.setCameraRotation(input);
          return <Object?, Object?>{};
        });
      }
    }
    {
      const BasicMessageChannel<Object?> channel =
          BasicMessageChannel<Object?>('dev.flutter.pigeon.VideoPlayerApi.setMediaFormat', StandardMessageCodec());
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setMediaFormat was null. Expected MediaFormatMessage.');
          final MediaFormatMessage input = MediaFormatMessage.decode(message!);
          api.setMediaFormat(input);
          return <Object?, Object?>{};
        });
      }
    }
